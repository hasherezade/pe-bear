...
public:
	...
	SignaturesBrowseModel(std::vector<pattern_tree::Signature*>& _signatures, QObject *parent = 0);
...
public:
	SignaturesBrowseWindow(std::vector<pattern_tree::Signature*>& signatures, QWidget *parent);
