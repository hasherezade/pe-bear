...
The **Windows** build with *vs19* suffix (built with Visual Studio 2019) requires [Microsoft Visual C++ 2015 Redistributable Package](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170).
